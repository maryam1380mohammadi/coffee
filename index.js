...
let username = prompt(" please Enter your username (user or admin):");
...
let coffeeType = prompt("coffee type? (espresso, latte, cappuccino)").toLowerCase();

let quantity = parseInt(prompt("age?"));
